...
test-extract_cli:
	...
	uv run syndatagenyolo/cli/extract_cli.py --input_dir test_data/foregrounds --output_dir tmp/foregrounds --margin 10
...
test-data-generation-with-bboxes:
	...
	uv run syndatagenyolo/cli/data_generation_cli.py -in_dir tmp -out_dir tmp/out -img_number 5 \
